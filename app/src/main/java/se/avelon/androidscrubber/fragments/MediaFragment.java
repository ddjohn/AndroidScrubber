    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        try {
            ...
            DisplayManager manager =
                    (DisplayManager) this.getContext().getSystemService(Context.DISPLAY_SERVICE);
            ...
            formatList.add(
                    "KEY_I_FRAME_INTERVAL=" + format.getInteger(MediaFormat.KEY_I_FRAME_INTERVAL));
            ...
            VirtualDisplay display =
                    manager.createVirtualDisplay(
                            "MyVirtualDevice", 640, 400, DisplayMetrics.DENSITY_HIGH, surface, 0);
