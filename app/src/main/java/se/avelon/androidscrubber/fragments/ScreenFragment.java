...
public class ScreenFragment extends AbstractFragment {
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        // this.getActivity().getSystemService(Context.POWER_SERVICE);
        final DevicePolicyManager manager =
                (DevicePolicyManager)
                        this.getActivity().getSystemService(Context.DEVICE_POLICY_SERVICE);
